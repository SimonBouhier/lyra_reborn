...
| P7 — Évaluation | tranche V4 : préfixe commun + branches contrebalancées + juge agentique pairwise ; NSGA-II non commencé | 🧪 harnais synthétique, aucune mesure réelle ([preuve](docs/P7_VERTICAL_SLICE.md)) |
