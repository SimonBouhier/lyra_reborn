...
| P7 | `eval/` | **TRANCHE V4 SYNTHÉTIQUE** : COMMON T1 partagé, branches ABBA/BAAB, contrat anti-vide, juge agentique aveugle + ordre inversé ; aucune mesure réelle. Restes : corpus tenu, scoreur C0–C10, logging de ressources, NSGA-II | `PREREGISTRATION_v4.md`, `docs/P7_VERTICAL_SLICE.md` |
